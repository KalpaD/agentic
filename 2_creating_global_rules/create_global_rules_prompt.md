# Copy-Paste Prompt: Create Global Rules for Your Project

Copy the text below and paste it into your AI coding assistant to generate your project's global rules (CLAUDE.md).
